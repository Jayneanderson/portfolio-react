        ...
        <section id="about" className="about-container">
            <div className="about-group">
                ...
                <div className="about-me">
                    ...
                    <p className="text">
                        Eu sou um desenvolvedor back-end com experiência na
                        construção de aplicações web e scripts em uma startup e
                        empresa de tecnologia. Possuo conhecimentos sólidos em
                        JavaScript, Node.js e no desenvolvimento de APIs REST.
                        Também tenho conhecimento com Python, React e banco de
                        dados relacional. Estou interessado em testes
